...
//
////        //garis merah celana dalam (gak jd)
////        stripMerah = new EllipticCone(
////                Arrays.asList(
////                        new ShaderProgram.ShaderModuleData("resources/shaders/scene.vert", GL_VERTEX_SHADER),
////                        new ShaderProgram.ShaderModuleData("resources/shaders/scene.frag", GL_FRAGMENT_SHADER)
////                ),
...
//            float degree = 0.7f;
//            System.out.println("count degree kaki: " + counterDegreeKakiBrown);
//            if (counterDegreeKakiBrown >= 60f) {
//                gantiArah *= -1;
//                counterDegreeKakiBrown = 0;
...
//            }
//            //kaki kanan
//            List<Float> temppB = new ArrayList<>(objectsBrown.get(4).getCenterPoint());
//            objectsBrown.get(4).translateObject(temppB.get(0)*-1, temppB.get(1)*-1, temppB.get(2)*-1);
...
//            objectsBrown.get(5).translateObject(temp1.get(0)*1,temp1.get(1)*1,temp1.get(2)*1);
//            //telapak kaki kanan
//            objectsBrown.get(6).translateObject(temppB.get(0)*-1, temppB.get(1)*-1, temppB.get(2)*-1);
...
//                object.rotateObject((float) Math.toRadians(ybadan), 0f, 1f, 0f);
//            }
//            counterDegreeKakiBrown += degree;
//        }
//
//        //animasi kepala geleng2
//        if(window.isKeyPressed(GLFW_KEY_N)){
//            float degree = 1f;
//            System.out.println("count degree kaki: " + counterDegreeGelengBrown);
//            if (counterDegreeGelengBrown >= 90f) {
//                gantiArah *= -1;
//                counterDegreeGelengBrown = 0;
//                System.out.println("ganti arah");
//            }
//            for (Object object : objectsBrown) {
//                object.rotateObject((float) Math.toRadians(-ybadan), 0f, 1f, 0f);
...
//                object.rotateObject((float) Math.toRadians(ybadan), 0f, 1f, 0f);
//            }
//            counterDegreeGelengBrown += degree;
//        }
//
