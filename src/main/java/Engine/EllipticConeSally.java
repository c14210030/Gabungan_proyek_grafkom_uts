...
public class EllipticConeSally extends Circle{
    float radiusZ;
    int stackCount;
    int sectorCount;
    public EllipticConeSally(List<ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, Vector4f color, List<Float> centerPoint, Float radiusX, Float radiusY, Float radiusZ,
